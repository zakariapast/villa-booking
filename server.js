...
app.get('/villas/:id', (req, res) => {
  res.sendFile(path.join(__dirname, 'views/public-villa-detail.html'));
});
...
app.get('/admin/villas/add', (req, res) => {
  res.sendFile(path.join(__dirname, 'views/admin/add-villa.html'));
});

app.get('/admin/villas/edit', (req, res) => {
  res.sendFile(path.join(__dirname, 'views/admin/edit-villa.html'));
});

app.get('/admin/rooms/list', (req, res) => {
  res.sendFile(path.join(__dirname, 'views/admin/list-rooms.html'));
});

app.get('/admin/rooms/add', (req, res) => {
  res.sendFile(path.join(__dirname, 'views/admin/add-room.html'));
});

app.get('/admin/rooms/edit', (req, res) => {
  res.sendFile(path.join(__dirname, 'views/admin/edit-room.html'));
});
